...
# Fotos na mesma pasta do app.py
BASE_DIR = os.path.dirname(os.path.abspath(__file__))

# ── Configuração da página ────────────────────────────────────────────────────
st.set_page_config(
    page_title="Feliz Aniversário, Dudinha! 🎂🩷",
    page_icon="🩷",
    layout="wide",
)
...
st.markdown("""
<div class="card">
  <div class="titulo-principal">🎂 Feliz Aniversário, Dudinha! 🩷</div>
  <div class="subtitulo">Hoje o dia é da fofura mais fofa do mundo (a Pipi autorizou, mas cobrou em petisco 🐾)</div>
...
st.markdown("""
<div class="card">
  <div class="secao-titulo">💌 Parabéns, Dudinha!</div>
  <div class="mensagem">
    Hoje é o seu dia, e o mundo acordou um pouquinho mais rosa por isso! 🎀<br><br>
    Mais um ano da obra de cerâmica mais linda já feita por você mesma, de um coração maior que uma viagem da Lagoa até Sepetiba
    (com trânsito) e de um perfume com notas de carinho e sabor de docinhos — o primeiro dos oito, claro. 🧴<br><br>
    Que esse novo ano venha com muita praia, abraços apertados, perfumes novos e zero alemães no caminho. 🇩🇪🚫
    E que o dente fake siga firme e forte, porque ninguém sorri tão bonito quanto você. 🦷✨<br><br>
    Você é incrível, linda, forte e especial — e a Pipi concorda, desde que sobre um pedacinho de bolo pra ela.
    (Ela também mandou dizer que me ama, mas isso é assunto pra outro dia.) 🐾<br><br>
    Feliz aniversário, Dudinha! Que venham muitos e muitos outros, sempre com essa sua fofura e com a Pipi pedindo comida do lado. 🥳🩷<br><br>
...
fotos_info = [
    ...
    (os.path.join(BASE_DIR, "foto5.jpg"), "Amor no verão 🌞"),
]
...
<div class="card" style="text-align:center;">
  <div class="secao-titulo">🏷️ Tudo que define a aniversariante</div>
  <span class="capsula">🎂 Aniversariante</span>
...
st.markdown("""
<div class="rodape">
  Feliz aniversário, Dudinha! Feito com muito 🩷 (CÓDIGO!!!!)
  <small>🌸 ✨ 🌸 ✨ 🌸</small>
</div>
""", unsafe_allow_html=True)
