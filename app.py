...
# Pasta de fotos sempre relativa ao app.py
...
fotos_info = [
    (os.path.join(FOTOS_DIR, "foto1.jpg"), "Duda & Pipi de Chapeuzinho 🧺"),
    (os.path.join(FOTOS_DIR, "foto2.jpg"), "A dupla mais estilosa 🐄✨"),
    (os.path.join(FOTOS_DIR, "foto3.jpg"), "Pipi na praia 🌊"),
    (os.path.join(FOTOS_DIR, "foto4.jpg"), "Melhor abraço do mundo 🤗"),
    (os.path.join(FOTOS_DIR, "foto5.jpg"), "Amor no verão 🌞"),
]
